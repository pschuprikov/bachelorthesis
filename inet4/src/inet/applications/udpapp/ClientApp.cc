...
Packet *ClientApp::createRequestPacket()
{
    char msgName[32];
    sprintf(msgName, "request-T%d", transactionID);
...
void ClientApp::processPacket(Packet *pk) //have a look at this : what do we do with an incoming packet
{
