//
// Generated file, do not edit! Created by nedtool 5.7 from inet/networklayer/ipv4/Ipv4Header.msg.
//
...
unsigned int Ipv4OptionTimestampDescriptor::getFieldTypeFlags(int field) const
{
    ...
    static unsigned int fieldTypeFlags[] = {
        ...
        FD_ISARRAY,    // FIELD_recordAddress
        FD_ISARRAY | FD_ISEDITABLE,    // FIELD_recordTimestamp
    };
...
bool Ipv4OptionTimestampDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case FIELD_recordTimestamp: pp->setRecordTimestamp(i,string2simtime(value)); return true;
        default: return false;
    }
}
