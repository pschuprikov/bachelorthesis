//
// Generated file, do not edit! Created by nedtool 5.7 from inet/routing/dymo/Dymo.msg.
//
...
bool AddressBlockDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case FIELD_validityTime: pp->setValidityTime(string2simtime(value)); return true;
