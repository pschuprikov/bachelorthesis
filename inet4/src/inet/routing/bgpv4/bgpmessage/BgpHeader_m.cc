//
// Generated file, do not edit! Created by nedtool 5.7 from inet/routing/bgpv4/bgpmessage/BgpHeader.msg.
//
...
bool BgpOpenMessageDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case FIELD_holdTime: pp->setHoldTime(string2simtime(value)); return true;
