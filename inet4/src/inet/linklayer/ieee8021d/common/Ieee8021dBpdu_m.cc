//
// Generated file, do not edit! Created by nedtool 5.7 from inet/linklayer/ieee8021d/common/Ieee8021dBpdu.msg.
//
...
bool BpduCfgDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case FIELD_messageAge: pp->setMessageAge(string2simtime(value)); return true;
        case FIELD_maxAge: pp->setMaxAge(string2simtime(value)); return true;
        case FIELD_helloTime: pp->setHelloTime(string2simtime(value)); return true;
        case FIELD_forwardDelay: pp->setForwardDelay(string2simtime(value)); return true;
        default: return false;
    }
}
