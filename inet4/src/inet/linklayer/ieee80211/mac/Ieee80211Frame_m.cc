//
// Generated file, do not edit! Created by nedtool 5.7 from inet/linklayer/ieee80211/mac/Ieee80211Frame.msg.
//
...
bool Ieee80211MacHeaderDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case FIELD_durationField: pp->setDurationField(string2simtime(value)); return true;
        case FIELD_AID: pp->setAID(string2long(value)); return true;
        case FIELD_MACArrive: pp->setMACArrive(string2simtime(value)); return true;
        default: return false;
    }
}
...
bool Ieee80211AddbaRequestDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case FIELD_blockAckTimeoutValue: pp->setBlockAckTimeoutValue(string2simtime(value)); return true;
